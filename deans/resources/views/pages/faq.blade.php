    ...
    <div class="" id="accordion">
         ...
         <div class="card ">
             ...
             <div id="collapseOne" class="panel-collapse collapse in">
                 <div class="card-block">
                    <p> Account registration at <strong>PrepBootstrap</strong> is only required if you will be selling or buying themes. 
                     This ensures a valid communication channel for all parties involved in any transactions. </p>
                 </div>
             </div>
         </div>
         <div class="card ">
             ...
             <div id="collapseTen" class="panel-collapse collapse">
                 <div class="card-block">
                    <p> A lot of the content of the site has been submitted by the community. Whether it is a commercial element/template/theme 
                     or a free one, you are encouraged to contribute. All credits are published along with the resources. </p>
                 </div>
             </div>
         </div>
         <div class="card ">
             ...
             <div id="collapseEleven" class="panel-collapse collapse">
                 <div class="card-block">
                    <p> All prices for themes, templates and other items, including each seller's or buyer's account balance are in <strong>USD</strong> </p>
                 </div>
             </div>
         </div>
         ...
         <div class="card ">
             ...
             <div id="collapseTwo" class="panel-collapse collapse">
                 <div class="card-block">
                     <p>Any registed user, who presents a work, which is genuine and appealing, can post it on <strong>PrepBootstrap</strong>.</p>
                 </div>
             </div>
         </div>
         <div class="card ">
         ...
         <div class="card ">
             ...
             <div id="collapseFive" class="panel-collapse collapse">
                 <div class="card-block">
                     <p>Here, at <strong>PrepBootstrap</strong>, we offer a great, 70% rate for each seller, regardless of any restrictions, such as volume, date of entry, etc.</p>
                     <br />
                 </div>
             </div>
         </div>
         <div class="card ">
             ...
             <div id="collapseSix" class="panel-collapse collapse">
                 <div class="card-block">
                     <p>There are a number of reasons why you should join us:
                     <ul>
         ...
         <div class="card ">
             ...
             <div id="collapseEight" class="panel-collapse collapse">
                 <div class="card-block">
                     <p>The best way to transfer funds is via Paypal. This secure platform ensures timely payments and a secure environment. </p>
                 </div>
             </div>
         </div>
         <div class="card ">
             ...
             <div id="collapseNine" class="panel-collapse collapse">
                 <div class="card-block">
                    <p> Our standard payment plan provides for monthly payments. At the end of each month, all accumulated funds are transfered to your account. 
                     The minimum amount of your balance should be at least 70 USD. </p>
                 </div>
             </div>
         </div>
         ...
         <div class="card ">
             ...
             <div id="collapseFour" class="panel-collapse collapse">
                 <div class="card-block">
                    <p> Buying a theme on <strong>PrepBootstrap</strong> is really simple. Each theme has a live preview. 
                     Once you have selected a theme or template, which is to your liking, you can quickly and securely pay via Paypal.
                     <br />
                     Once the transaction is complete, you gain full access to the purchased product. </p>
                 </div>
             </div>
         </div>
         <div class="card ">
             ...
             <div id="collapseSeven" class="panel-collapse collapse">
                 <div class="card-block">
                    <p>Each item in <strong>PrepBootstrap</strong> is maintained to its latest version. This ensures its smooth operation.</p> 
                 </div>
             </div>
         </div>
     </div>
